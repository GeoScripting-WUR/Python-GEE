...
```{python, eval=FALSE}
# Note: we don't recomend running this line if you are using VM Box virtual machines as they might cause it to crash, however, we still would like to show this option of getting info, as it is displayed more clearly within Jupyter Notebook.
